...
class Student {
    ...
    public Student(int id, String name, String parent, String level, String phone, String city, String course) {
        this.id = id;
        this.name = name;
        this.parent = parent;
        this.level = level;
    ...
    public String toString() {
        return id + "\t" + name + "\t\t" + parent + "\t" + level + "\t" + phone + "\t" + city + "\t" + course;
    }
}
    ...
    public static void saveStudentsToFile() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                studentList.add(new Student(id, name, parent, level, phone, city, course));
            }
            ...
            if (!hasData) {
                ...
                try (BufferedWriter writer = new BufferedWriter(new FileWriter("students_output.txt"))) {
                    writer.write("ID\tName\tParent\tLevel\tPhone\tCity\tCourse\n");
